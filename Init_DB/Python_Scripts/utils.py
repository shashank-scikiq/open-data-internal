...
def generate_req_envs(f_name: str, env: str) -> list:
    """
    ...
    L2_TBLS = [key.split("\n")[0] for key in env_dict if (env == "prod" and any(kw in key for kw in prod_kws) and not any(kw in key for kw in stage_kws) 

...
class FetchMaxDate(APIView):
    ...
    def get(self, request: HttpRequest, *args, **kwargs):
        ...
        p_d = "FetchMaxDate_Retail_Overall$$$"
...
class FetchTopCardDeltaData(SummaryBaseDataAPI):
    ...
    def generate_cache_key(self, params):
        ...
        return "FetchTopCardDeltaData_Retail_Overall_$$$".join(cleaned_list)
...
class FetchMapStateWiseData(SummaryBaseDataAPI):
    ...
    def get(self, request, *args, **kwargs):
        ...
        p_d = "FetchMapStateWiseData_Retail_Overall_$$$".join(cleaned_list)
...
class FetchMapStateData(SummaryBaseDataAPI):
    ...
    def get(self, request, *args, **kwargs):
        ...
        p_d = "FetchMapStateData_Retail_Overall_$$$".join(cleaned_list)
...
class FetchTopStatesOrders(SummaryBaseDataAPI):
    ...
    def get(self, request, *args, **kwargs):
        ...
        p_d = "FetchTopStatesOrders_Retail_Overall_$$$".join(params_list)
...
class FetchCumulativeOrders(SummaryBaseDataAPI):
    ...
    def get(self, request, *args, **kwargs):
        ...
        p_d = "FetchCumulativeOrders_Retail_Overall_$$$".join(params_list)
...
class FetchCumulativeSellers(SummaryBaseDataAPI):
    ...
    def get(self, request, *args, **kwargs):
        ...
        p_d = "FetchCumulativeSellers_Retail_Overall_$$$".join(params_list)
...
class FetchTopDistrictOrders(SummaryBaseDataAPI):
    ...
    def get(self, request, *args, **kwargs):
        ...
        p_d = "FetchTopDistrictOrders_Retail_Overall_$$$".join(params_list)
...
class FetchTopStatesHyperlocal(SummaryBaseDataAPI):
    ...
    def get(self, request, *args, **kwargs):
        ...
        p_d = "FetchTopStatesHyperlocal_Retail_Overall_$$$".join(params_list)
...
class FetchTopDistrictHyperlocal(SummaryBaseDataAPI):
    ...
    def get(self, request, *args, **kwargs):
        ...
        p_d = "FetchTopDistrictHyperlocal_Retail_Overall_$$$".join(params_list)
...
class FetchTop5SellerStates(SummaryBaseDataAPI):
    ...
    def get(self, request, *args, **kwargs):
        ...
        p_d = "FetchTop5SellerStates_Retail_Overall_$$$".join(params_list)
...
class FetchTop5SellersDistrict(SummaryBaseDataAPI):
    ...
    def get(self, request, *args, **kwargs):
        ...
        p_d = "FetchTop5SellersDistrict_Retail_Overall_$$$".join(params_list)
...
class FetchTop5DeliveryState(SummaryBaseDataAPI):
    ...
    def get(self, request, *args, **Kwargs):
        ...
        p_d = "FetchTop5DeliveryState_Retail_Overall_$$$".join(param_list)
        data= get_cached_data(p_d)
        if data is None:
...
class FetchTop5DeliveryDistrict(SummaryBaseDataAPI):
    ...
    def get(self, request, *args, **kwargs):
        ...
        p_d = "FetchTop5DeliveryDistrict_Retail_Overall_$$$".join(params_list)

class DataService:
    ...
    def get_top_district_sellers(self, start_date, end_date, category=None, sub_category=None, domain_name=None,
                                state=None):
        return self.dal.fetch_top_district_sellers(start_date, end_date, category, sub_category, domain_name, state)

    def get_top_state_sellers(self, start_date, end_date, category=None, sub_category=None, domain_name=None,
                                state=None):
        return self.dal.fetch_top_state_sellers(start_date, end_date, category, sub_category, domain_name, state)
    ...
    def get_category_penetration_orders(self, start_date, end_date, category=None, sub_category=None, domain_name=None, state=None):
        return self.dal.fetch_category_penetration_orders(start_date, end_date, category, sub_category, domain_name, state)
    
    def get_category_penetration_sellers(self, start_date, end_date, category=None, sub_category=None, domain_name=None, state=None):

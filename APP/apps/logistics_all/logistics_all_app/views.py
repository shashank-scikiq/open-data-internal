...
class SummaryBaseDataAPI(APIView):
    ...
    def extract_common_params(self, request):
        ...
        if domain_name == 'None' or domain_name == 'undefined' or domain_name == 'null' or domain_name==None:
    ...
    def get(self, request, *args, **kwargs):
        ...
        with connection.cursor() as conn:
            ...
            downloadable_data_df = self.convert_decimal_to_float(
                fetch_downloadable_data_logistics_overall(conn, start_date, end_date, domain_name, tab_name))

...
@Component({
  selector: 'app-domain-mapping',
  templateUrl: './domain-mapping.component.html',
  styleUrl: './domain-mapping.component.scss'
})
export class DomainMappingComponent  implements OnInit {
  ...
  ngOnInit(): void {
    this.loading = true;
    this.appService.getDomainData().subscribe(
      (response: any) => {

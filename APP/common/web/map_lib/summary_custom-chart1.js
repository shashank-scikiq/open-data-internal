...
$(document).ready(function() {
    ...
    function dateRangeFilter() {
        ...
        start_year = startDateString.split(',')[1].trim()
        start_month = startDateString.split(',')[0].trim()
        end_year = endDateString.split(',')[1].trim()
        end_month = endDateString.split(',')[0].trim()
